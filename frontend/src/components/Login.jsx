    ...
    return (
        <div className="flex justify-center items-center min-h-[85vh] px-4">
            <div className="bg-[#fdf6e3] p-10 max-w-md w-full relative shadow-[12px_12px_0px_rgba(30,15,5,0.6)] border-4 border-double border-amber-900 rounded-sm">
                ...
                <div className="flex justify-center mb-4 text-amber-900"><Compass size={48} strokeWidth={1.5} /></div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input type="email" required className="w-full pl-10 p-3 bg-amber-50 border-2 border-amber-900/40 text-amber-950 focus:bg-[#fdf6e3] focus:ring-0 focus:border-amber-900 transition-colors outline-none font-sans font-medium" placeholder="adventurer@sidequest.com" value={email} onChange={(e) => setEmail(e.target.value)} />
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input type="password" required className="w-full pl-10 p-3 bg-amber-50 border-2 border-amber-900/40 text-amber-950 focus:bg-[#fdf6e3] focus:ring-0 focus:border-amber-900 transition-colors outline-none font-sans font-medium" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} />
                        </div>
                    </div>
                    <button type="submit" disabled={isLoading} className="w-full bg-amber-900 hover:bg-amber-950 text-[#fdf6e3] font-bold py-4 border-2 border-amber-950 shadow-[4px_4px_0px_rgba(69,26,3,1)] hover:shadow-none hover:translate-y-1 hover:translate-x-1 transition-all duration-150 flex justify-center items-center uppercase tracking-widest disabled:opacity-70 disabled:cursor-not-allowed">
